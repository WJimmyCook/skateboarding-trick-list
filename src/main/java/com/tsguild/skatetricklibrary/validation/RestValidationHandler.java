 ...
 */
package com.tsguild.skatetricklibrary.validation;
...
public class RestValidationHandler {
    ...
    public ValidationErrorContainer processValidationErrors(MethodArgumentNotValidException e) {
        // Efffectively kind of like a "Catch" for thrown Controller exexceptions of type MethodArgumentNotValidException
