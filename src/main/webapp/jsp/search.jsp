                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a href="${pageContext.request.contextPath}/home" 
                           class="navbar-left"><img src="${pageContext.request.contextPath}/img/Skateboard-logo-blue.png" class="img-logo"></a>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" 
                                       id="search-name" placeholder="Trick Name" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="search-category" class="col-md-4 control-label">
                                Category:
                            </label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" 
                                       id="search-category" placeholder="Category" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="search-type" class="col-md-4 control-label">
                                Type:
                            </label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" 
                                       id="search-type" placeholder="Type" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" 
                                       id="search-rating" placeholder="Rating" />
                            </div>
                        </div>
                        <div class="form-group">
